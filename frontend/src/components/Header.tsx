          ...
          <nav className="hidden lg:flex items-center gap-6">
            ...
            {isAuthenticated ? (
              <>
                ...
                {isProfessional && (
                  <>
                    <Link href="/create-offer" className="px-4 py-2 bg-gradient-to-r from-green-500 to-emerald-500 text-white font-semibold rounded-lg hover:from-green-600 hover:to-emerald-600 transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105 text-sm">
                      ➕ Offre
                    </Link>
                    <Link href="/planifier-visio" className="px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold rounded-lg hover:from-purple-600 hover:to-pink-600 transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105 text-sm">
                      📅 Planifier
                    </Link>
